...
object  ManagingNulls extends App {
  ...
  //remove null
  moviesDF.select("Title","IMDB_Rating").na.drop()  //remove row contains null
  ...
  moviesDF.selectExpr(
    ...
    "nullif(Rotten_Tomatoes_Rating, IMDB_Rating * 10) as nullif", //returns null if two values are equal,else retunr first value
